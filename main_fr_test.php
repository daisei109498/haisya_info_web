...
<body>
	<div class="exContainer">
		...
		<p style="text-align: right"><button onclick="location.href='stock_fr.php'">ストック品回収履歴</button><button onclick="location.href='history_fr.php'">受領履歴検索</button><button onclick="location.href='logout.php'">ログアウト</button> </P>
	</div>
		最新情報<BR> 
